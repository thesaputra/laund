...
<span>---------------------------------------------------</span>
<br/>
<span style="font-size:13px" class="span-header">No.{{$invoice}}</span><br/><span style="font-size:13px" class="span-header">Order: {{ date('d-m-Y', strtotime($data['transaction']->date_order))}}</span> <br/>
